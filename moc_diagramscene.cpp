...
#include "../../../Desktop/Code/cs240-lab7-src/diagramscene.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DiagramScene_t, stringdata) + ofs \
...
void *DiagramScene::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DiagramScene.stringdata))
